...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  // If no price was passed from the picker, fetch it from Admin API
...
export default function NewOffer() {
  ...
  useEffect(() => {
    if (
      ...
      shopify.toast.show("Offer created");
      navigate("/app");
    }
        ...
        <s-stack gap="base">
          {selectedProduct ? (
            ...
            <s-stack gap="small-200">
              ...
              <s-button onClick={handleProductPicker}>Select product</s-button>
            </s-stack>
          )}
        </s-stack>
      </s-section>
                    ...
                    <s-stack gap="small-200">
                      {rule.productTitle ? (
                        <s-box padding="small-200" borderWidth="base" borderRadius="base">
                          <s-stack direction="inline" gap="base">
                            <s-text>{rule.productTitle}</s-text>
                            <s-button
